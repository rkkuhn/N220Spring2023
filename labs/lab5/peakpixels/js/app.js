...
black. The green was on top and the black was under the color. I removed the
canvas and the draw function(s). */

// Create the start of the function to increase the size of the square
function peakPixels(){
